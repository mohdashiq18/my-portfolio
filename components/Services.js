  ...
  const services = [
    {
      ...
      text: "Design beautiful, user-friendly websites that enhance your online presence.",
    },
    {
      id: 2,
      title: "Mobile Application Design",
      text: "Design beautiful, user-friendly mobile interfaces that enhance your app's presence.",
    },
    {
      id: 3,
      title: "Website Development",
      text: "Create beautiful, user-friendly websites that enhance your online presence.",
    },
    {
      id: 4,
      title: "Mobile Application Development",
      text: "Create beautiful, user-friendly mobile apps that enhance your app's presence.",
    },
    // {
    //   id: 5,
    //   title: "Website Development",
          ...
          <div className="col-xl-6 col-lg-8">
            <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
              ...
              <h2>
               ...
               Boosting <span> Career Growth</span> My Unique Services
              </h2>
            </div>
          </div>
        </div>
