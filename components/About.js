  ...
  return (
    <section id="about" className="about-area rel z-1">
      <div className="for-bgc-black py-130 rpy-100">
        <div className="container" id="about-s">
          <div className="row gap-100 align-items-center">
            <div className="col-lg-7" >
              <div className="about-content-part rel z-2 rmb-55"  >
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <p>
                    Passionate full-stack developer specializing in mobile and web, ready to collaborate on your next project. Let's connect
                  </p>
                </div>
                ...
                <div className="about-info-box mt-25 wow fadeInUp delay-0-2s">
                  <div className="info-box-item">
                    ...
                    <div className="content">
                      <span>Email Us</span>
                      <br />
                      <a href="mailto:moashiq2018gmail.com">moashiq2018gmail.com</a>
                    </div>
                  </div>
                  <div className="info-box-item">
                    ...
                    <div className="content">
                      ...
                      <br />
                      <a href="callto:+91 7084017971">+91-7084017971</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-5">
              <div className="about-image-part wow fadeInUp delay-0-3s">
                <img style={{borderRadius:'10px'}} src="assets/images/about/about.jpg" alt="About Me" />
