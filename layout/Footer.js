          ...
          <div className="row">
            ...
            <div className="col-lg-7 col-md-7">
              <div className="footer-widget widget_nav_menu wow fadeInUp delay-0-4s">
                ...
                <ul>
                  ...
                  <li>
                    <Link legacyBehavior href="#about-s">
                      About
                    </Link>
                  </li>
                  <li>
            ...
            <div className="col-lg-3 col-md-5">
              <div className="footer-widget widget_contact_info wow fadeInUp delay-0-6s">
                ...
                <ul>
                  <li>
                    <i className="far fa-map-marker-alt" /> 45/55 Turab Ali Ka Purwa, Fatehpur, Utter Predesh
                  </li>
                  <li>
                    <i className="far fa-envelope" />{" "}
          ...
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              <ul className="footer-bottom-nav">
                <li>
                  <a href="https://github.com/mohdashiq18" target="_blank">GitHub</a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/ashique18/" target="_blank">LinkedIn</a>
                </li>
                <li>
                  <a  href="https://x.com/moashiq18" target="_blank">Twitter</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/ashiq_.ali_?igsh=ZTh0YmJ1dXZpODZj" target="_blank">Instagram</a>
                </li>
              </ul>
            </div>
          </div>
